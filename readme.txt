...
1. After activation go to 'Settings > WP Page Extension'.
...
Go to 'Settings > WP Page Extension' and enter your custom page permalink and hit 'save changes'.

= Is there an admin interface for this plugin? =

Yes. You can access this from 'Settings > WP Page Extension'
